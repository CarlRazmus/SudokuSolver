...
public class SudokuBoard 
{
	...
	public void createHardTestBoard()
	{
		int[] row1 = {UNASSIGNED, UNASSIGNED, 2, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED};
		int[] row2 = {UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, 9, UNASSIGNED, UNASSIGNED, UNASSIGNED};
		int[] row3 = {7, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, 6, UNASSIGNED};
		int[] row4 = {UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, 5, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED};
		int[] row5 = {UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED,3, UNASSIGNED, UNASSIGNED};
		int[] row6 = {UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, 8};
		int[] row7 = {UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, 4, 7, UNASSIGNED};
		int[] row8 = {UNASSIGNED, UNASSIGNED, UNASSIGNED, 7, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED};
		int[] row9 = {UNASSIGNED, UNASSIGNED, 9, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED, UNASSIGNED};
		board[0] =  row1;
		board[1] =  row2;
		board[2] =  row3;
		board[3] =  row4;
...
//		System.out.println("\nrow " + (row + 1 ) + " column " + (column+1) + " square " + square);
	...
	{
		return contains1to9(getSquareArray(square));
	}
